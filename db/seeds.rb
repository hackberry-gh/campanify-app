campaign = Campaign.create(name: "cryptic-reef-7342")
campaign.slug = "cryptic-reef-7342"
campaign.save!
campaign.setup if Rails.env.production?

admin = Administrator.create!(email: 'admos@camp.it', full_name: "admos", role: "root")
admin.password = "123456"
admin.password_confirmation = "123456"
admin.save!

user = User.create!(first_name: "John2", last_name: "Doe2", email: "johndoe2@campanify.it")
